...
import com.jjsttk.goodswarehouse.mapper.product.converter.ProductEntityToBaseProductServiceDtoConverter;
...
class ProductEntityToBaseProductServiceDtoResponseConverterTest {
    private ProductEntityToBaseProductServiceDtoConverter converter;

    @BeforeEach
    void setUp() {
        converter = new ProductEntityToBaseProductServiceDtoConverter();
    }
