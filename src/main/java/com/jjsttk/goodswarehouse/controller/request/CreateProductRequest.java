...
import com.jjsttk.goodswarehouse.controller.request.validation.UniqueArticle;
...
public final class CreateProductRequest {
    ...
    @Schema(description = "Unique product article code. Must not duplicate existing articles",
    ...
    @Schema(description = "Detailed product description. Optional field",
    ...
    @Schema(description = "Quantity available in stock",
            example = "100",
            minimum = "0",
