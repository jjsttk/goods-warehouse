...
public record GetProductResponse(
        ...
        @Schema(description = "Unique article number (SKU)",
        ...
        @Schema(description = "Quantity of product available in stock",
                example = "150")
        BigDecimal quantity,

        @Schema(description = "Timestamp with timezone offset when product quantity was last modified",
                example = "2025-08-28T12:45:30+03:00")
        OffsetDateTime lastQuantityModified,

        @Schema(description = "Timestamp with timezone offset when the product was created",
