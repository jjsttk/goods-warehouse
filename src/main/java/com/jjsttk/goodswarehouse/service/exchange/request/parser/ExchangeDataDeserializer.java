package com.jjsttk.goodswarehouse.service.exchange.request.parser;
...
public class ExchangeDataDeserializer extends JsonDeserializer<ExchangeData> {
    ...
    private PriceCurrency toCurrencyOrThrow(String currencyCode) {
        try {
            return PriceCurrency.valueOf(currencyCode);
