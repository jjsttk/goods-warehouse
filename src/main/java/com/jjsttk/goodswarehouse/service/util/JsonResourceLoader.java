package com.jjsttk.goodswarehouse.service.util;
...
public class JsonResourceLoader {
    ...
    public <T> T loadObject(String fileName, Class<T> type) {
        try {
            ...
            if (!resource.exists()) {
                throw new IOException("Resource does not exist: " + fileName);
            }

            T result = objectMapper.readValue(resource.getInputStream(), type);
