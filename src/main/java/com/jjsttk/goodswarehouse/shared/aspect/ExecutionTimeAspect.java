...
import com.jjsttk.goodswarehouse.shared.annotation.LogMethodExecutionTime;
...
public final class ExecutionTimeAspect {
     ...
     */
    @Around("@annotation(com.jjsttk.goodswarehouse.shared.annotation.LogMethodExecutionTime)")
