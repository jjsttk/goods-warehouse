...
dependencies {
    ...
    testImplementation("org.testcontainers:testcontainers:2.0.2") // solution :)
    //testImplementation("org.springframework.boot:spring-boot-testcontainers") bugged with Docker Version 4.62.0 (219486)
